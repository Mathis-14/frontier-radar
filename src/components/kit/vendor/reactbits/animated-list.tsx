// @ts-nocheck — vendored ReactBits (TS+Tailwind variant)
// Source: https://github.com/DavidHDev/react-bits/blob/main/src/ts-tailwind/Components/AnimatedList/AnimatedList.tsx (reactbits.dev)
// Fetched: 2026-07-22
// Local modifications:
//   - imports rewritten motion/react -> framer-motion (identical API in v12)
//   - "use client" added (kit RSC rule: every kit file is a client component)
//   - header added; otherwise verbatim
"use client";
